        ...
        <div class="row g-0">
            <div class="col-3 d-none d-md-block border-end">
                <div class="card-body">
                    ...
                    <div class="list-group list-group-transparent">
                        <a href="{{ route('app-users-profile-change-password', $user->slug) }}" class="list-group-item list-group-item-action active">Kata Sandi</a>
                    </div>
                </div>
            </div>
            <div class="col d-flex flex-column">
                <div class="card-body">
                    ...
                    <div class="row g-3 mb-3">
                        <div class="col-lg">
                            <a class="btn" id="buttonResetPassword" data-slug="{{ $user->slug }}">
                                Kembalikan ke awal
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="row g-3">
                        <div class="col-lg">
                            <div class="col-lg">
                                <a class="btn" id="buttonChangePassword" data-slug="{{ $user->slug }}">
                                    Ubah kata sandi
                                </a>
                            </div>
                        </div>
