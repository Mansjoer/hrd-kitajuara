...
@section('content')
    ...
    <form action="{{ route('app-employees-update', $user->slug) }}" method="POST" spellcheck="false" autocomplete="off" id="formKaryawan" enctype="multipart/form-data">
        {{ csrf_field() }}
        <div class="row">
            <div class="col-lg-8">
                <div class="card mb-3">
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <select name="company" type="text" class="form-select tomSelect" placeholder="Pilih perusahaan...">
                                            <option value=""></option>
                                            <option value="PT JUARA ELOK NUSANTARA" {{ $user->employee->company == 'PT JUARA ELOK NUSANTARA' ? 'selected' : '' }}>PT JUARA ELOK NUSANTARA</option>
                ...
                <div class="sticky-top" style="top: 16px;">
                    <div class="col-12">
                        <div class="card mb-3 placeholder-glow">
                            <div class="card-body">
                                <h3 class="card-title">Privasi </h3>
                                <div class="row row-cards">
                                    <div class="col-lg-12">
                                        <div class="mb-3">
                                            <label class="form-label">Pin</label>
                                            <a class="btn w-100" id="buttonResetPin" data-slug="{{ $user->slug }}">
                                                Setel ulang pin
                                            </a>
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="mb-3">
                                            ...
                                            <a class="btn w-100" id="buttonResetPassword" data-slug="{{ $user->slug }}">
...
@section('cscript')
    <script>
        ...
        $('#buttonResetPin').on('click', function() {
            var slug = $(this).data('slug');

            $.ajax({
                type: "POST",
                url: "{{ route('app-post-reset-pin') }}",
                data: {
                    slug: slug
                },
                dataType: "JSON",
                success: function(response) {
                    $('#alertSuccessText').html('Pin berhasil di setel ulang!');
                    $('#alertSuccess').fadeIn('slow').delay(2000).fadeOut('slow');
                }
            });
        });
